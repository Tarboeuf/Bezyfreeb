...
namespace BezyFB_UWP
{
    ...
    /// </summary>
    public sealed partial class TorrentDetailPage : Page
    {
        private static DependencyProperty s_itemProperty
               = DependencyProperty.Register("Item", typeof(Torrent), typeof(TorrentDetailPage), new PropertyMetadata(null));
        ...
        public Torrent Item
        {
            get { return (Torrent)GetValue(s_itemProperty); }
        ...
        public static readonly DependencyProperty DetailsProperty =
            DependencyProperty.Register("Details", typeof(TorrentDetails), typeof(TorrentDetailPage), new PropertyMetadata(null));
